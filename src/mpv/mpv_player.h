...
class MpvPlayer : public QQuickFramebufferObject {
	...
	Q_SLOT void handleFileEnd(const QString& reason) const;
...
public:
	...
	Q_SLOT void onPlaylist(bool playlist) const;
	Q_SIGNAL void playlistChanged(bool playlist) const;

	Q_SLOT void togglePause() const;
	Q_SLOT void setPause(bool pause) const;
	Q_SIGNAL void paused(bool paused) const;
	...
	Q_SIGNAL void muted(bool muted) const;
	...
	Q_SIGNAL void subtitleTrackChangedExt(const QVariant& subtitle) const;

	Q_SLOT void playMovie(const QMap<QString, QVariant>& args);
	Q_SIGNAL void isPlaylist(bool playlist) const;
	Q_SLOT void stopMovie() const;
	Q_SLOT void nextMovie() const;
	Q_SLOT void previousMovie() const;

	Q_SIGNAL void movieStarted(const QString& file) const;
	Q_SIGNAL void movieStopped(const QString& reason) const;
	...
	Q_SIGNAL void subtitlesVisible(bool visible) const;
};
}}
