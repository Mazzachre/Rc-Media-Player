...
rc::mpv::MpvController::MpvController(bool verbose, QObject *parent): QObject(parent) {
...
void rc::mpv::MpvController::mpvEvents(void *ctx) {
	QMetaObject::invokeMethod(static_cast<MpvController *>(ctx), &MpvController::eventHandler, Qt::QueuedConnection);
}

mpv_handle *rc::mpv::MpvController::mpv() const {
	return m_mpv;
}

QVariant rc::mpv::MpvController::setProperty(const QString &property, const QVariant &value) {
	mpv_node node;
	setNode(&node, value);
...
QVariant rc::mpv::MpvController::getProperty(const QString &property) {
	mpv_node node;
...
QVariant rc::mpv::MpvController::command(const QVariant &params) {
	mpv_node node;
	setNode(&node, params);
	mpv_node result;
...
Q_INVOKABLE void rc::mpv::MpvController::observeProperty(const QString &property, const mpv_format format) {
	mpv_observe_property(m_mpv, 0, qstrdup(property.toUtf8().data()), format);
}

void rc::mpv::MpvController::eventHandler() {
	while (m_mpv) {
