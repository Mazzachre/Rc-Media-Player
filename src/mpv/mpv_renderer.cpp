...
{
	QMetaObject::invokeMethod(static_cast<rc::mpv::MpvPlayer *>(ctx), &rc::mpv::MpvPlayer::update, Qt::QueuedConnection);
}

rc::mpv::MpvRenderer::MpvRenderer(MpvPlayer *player): m_player{player} {
	m_player->window()->setPersistentOpenGLContext(true);
}

QOpenGLFramebufferObject* rc::mpv::MpvRenderer::createFramebufferObject(const QSize &size) {
...
void rc::mpv::MpvRenderer::render() {
